...
import { getAgencyName, getCategoryLabel } from './home-types';

/* ─── Skeleton loader for the grid ─── */
export function AgencyCardSkeleton() {
  return (
    <div className="relative overflow-hidden rounded-2xl shimmer-loading">
...
/* ─── Empty state ─── */
export function AgencyEmptyState({ t }: { t: (key: TranslationKeys) => string }) {
  return (
